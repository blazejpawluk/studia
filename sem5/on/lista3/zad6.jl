...
println("metoda &\$f1=e^{1-x}-1\$ \\\\ \\hline")
...
if err == 0
	println("metoda Newtona (\$x_0<1\$) &$r \\\\ ")
else
	println("metoda Newtona (\$x_0<1\$) &błąd \\\\ ")
end
...
if err == 0
	println("metoda siecznych (\$x_0, x_1>1\$) &$r \\\\ ")
else
	println("metoda siecznych (\$x_0, x_1>1\$) &błąd \\\\ ")
end
