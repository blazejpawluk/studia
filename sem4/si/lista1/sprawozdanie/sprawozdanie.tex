...
\section*{Trenowanie modelu i statystyki z treningu}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/training_stats.png}
...
\section*{Testy na zbiorze MNIST}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/mnist_test_stats.png}
		\caption{Statystyki: accuracy, precision, recall, loss, w teście na zbiorze EMNIST MNIST}
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/mnist_conf_matrix.png}
...
\section*{Import własnego zbioru testowego}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/test_number.png}
...
\section*{Testy na własnym zbiorze testowym}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/my_test_stats.png}
		\caption{Statystyki: accuracy, precision, recall, loss, w teście na moim zbiorze}
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/my_conf_matrix.png}
...
\section*{Testowanie Random Forest na zbiorze EMNIST MNIST}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/tree_mnist_test_stats.png}
		\caption{Statystyki: accuracy, precision, recall, loss, w teście Random Tree na zbiorze EMNIST MNIST}
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/tree_mnist_conf_matrix.png}
...
\section*{Testy Random Tree na własnym zbiorze testowym}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/tree_my_test_stats.png}
		\caption{Statystyki: accuracy, precision, recall, loss, w teście Random Tree na moim zbiorze}
	\end{figure}

	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\textwidth]{images/tree_my_conf_matrix.png}
