...
def main():
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-ascending-comparisons.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-random-comparisons.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-ascending-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-random-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-ascending-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-random-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-insert-comps.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-delete-comps.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-insert-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-delete-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-insert-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/rbbst-delete-height.png')
	plt.close()
