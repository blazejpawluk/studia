...
def main():
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-ascending-comparisons.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-random-comparisons.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-ascending-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-random-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-ascending-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-random-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-insert-comps.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-delete-comps.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-insert-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-delete-reads.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-insert-height.png')
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig('charts/splay-delete-height.png')
	plt.close()
