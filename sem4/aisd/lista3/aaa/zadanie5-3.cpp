...
int main() {
	...
	std::ofstream fileQS("results/quickSortTestW.txt");
	std::ofstream fileQSS("results/quickSelectSortTestW.txt");
	std::ofstream fileDPQS("results/DPQuickSortTestW.txt");
	std::ofstream fileDPQSS("results/DPQuickSelectSortTestW.txt");
