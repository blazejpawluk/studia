...
def main():
	files = {
		'quickSort': 'results/quickSortTest.txt',
		'quickSelectSort': 'results/quickSelectSortTest.txt',
		'DPQuickSort': 'results/DPQuickSortTest.txt',
		'DPQuickSelectSort': 'results/DPQuickSelectSortTest.txt'
	}
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig("charts/5-2_comps.png")
	plt.close()
	...
	plt.grid(True)
	plt.tight_layout()
	plt.savefig("charts/5-2_time.png")
	plt.close()
