...
int main() {
	...
	std::ofstream file("results/binSearchTest.txt");
	...
	for (int n = 1000; n <= 100000; n += 1000) {
		...
		for (int m = 0; m < 100; m++) {
			...
			file << "ran " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
			...
			file << "beg " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
			...
			endTime = std::chrono::high_resolution_clock::now();
			elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(endTime - startTime).count();
			file << "mid " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
			...
			endTime = std::chrono::high_resolution_clock::now();
			elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(endTime - startTime).count();
			file << "end " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
			...
			endTime = std::chrono::high_resolution_clock::now();
			elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(endTime - startTime).count();
			file << "not " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
			...
			endTime = std::chrono::high_resolution_clock::now();
			elapsed = std::chrono::duration_cast<std::chrono::nanoseconds>(endTime - startTime).count();
			file << "inA " << n << " " << b.c.getComps() << " " << elapsed << std::endl;
		}
	}
